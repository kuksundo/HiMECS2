...
type
  ...
  public
    ...
    procedure LoadConfigForm2EngParamItem(AEPItem:TEngineParameterItem);
  ...
  function ShowEngParamItemConfigForm(AEPItem:TEngineParameterItem): integer;

var
  EngParamItemConfigForm2: TEngParamItemConfigForm2;

implementation

uses UnitEngineParamConst;

{$R *.dfm}

function ShowEngParamItemConfigForm(AEPItem:TEngineParameterItem): integer;
var
  LForm: TEngParamItemConfigForm2;
begin
  LForm := TEngParamItemConfigForm2.Create(nil);
  try
    LForm.LoadConfigEngParamItem2Form(AEPItem);
    Result := LForm.ShowModal;

    if Result = mrOK then
    begin
      LForm.LoadConfigForm2EngParamItem(AEPItem);
    end;
  finally
    LForm.Free;
  end;
...
procedure TEngParamItemConfigForm2.LowFaultEnableCBClick(Sender: TObject);
begin
...
procedure TEngParamItemConfigForm2.DigitalValue2Form(
...
procedure TEngParamItemConfigForm2.DigitalValueFromForm(
  AEPItem: TEngineParameterItem);
begin
  //Digital Type은 MinAlarm* 변수를 사용함
...
procedure TEngParamItemConfigForm2.DisableOtherAlarmConfigUI(
...
begin
  ...
  g_PanelKind4AVAT2.SetType2Combo(PanelNameCombo);
  g_TBKind4AVAT2.SetType2Combo(TBNameCombo);
end;

procedure TEngParamItemConfigForm2.LimitValue2Form(
  AEPItem: TEngineParameterItem);
begin
...
procedure TEngParamItemConfigForm2.LimitValueFromForm(
  AEPItem: TEngineParameterItem);
begin
  with AEPItem do
  begin
...
procedure TEngParamItemConfigForm2.LoadConfigEngParamItem2Form(
  AEPItem: TEngineParameterItem);
var
  LStr: string;
begin
  ...
  UnitEdit.Text := AEPItem.FUnit;
  ScaleEdit.Text := AEPItem.Scale;
  ...
  DisplayFormatEdit.Text := AEPItem.DisplayFormat;
...
//  SensorType2Combo(SensorTypeCombo);
  ...
  InitCombo;
  PanelNameCombo.Text := g_PanelKind4AVAT2.ToString(AEPItem.PanelName);
  TBNameCombo.Text := g_TBKind4AVAT2.ToString(AEPItem.TBName);
  TBNoEdit.Text := AEPItem.TBNo;
  DrawingNoEdit.Text := AEPItem.DrawingNo;
  ManualNoEdit.Text := AEPItem.ManualNo;
  //--------- Limit Value Page --------------
  //Analog Type
...
procedure TEngParamItemConfigForm2.LoadConfigForm2EngParamItem(AEPItem: TEngineParameterItem);
//var
...
//    LEngineParameterItem := AEP.EngineParameterCollect.Items[Result];
    ...
    begin
      ...
      DisplayFormat := DisplayFormatEdit.Text;

      if ParameterSource = psManualInput then
        Value := ManualInputValueEdit.Text;

      //--------- Classfy Page --------------
      SensorType := g_SensorType.ToType(SensorTypeCombo.Text);
      ...
      PanelName := g_PanelKind4AVAT2.ToType(PanelNameCombo.Text);
      TBName := g_TBKind4AVAT2.ToType(TBNameCombo.Text);
      TBNo := TBNoEdit.Text;
      DrawingNo := DrawingNoEdit.Text;
      ManualNo := ManualNoEdit.Text;
      //--------- Limit Value Page --------------
...
procedure TEngParamItemConfigForm2.LowAlarmEnableCBClick(Sender: TObject);
begin
...
procedure TEngParamItemConfigForm2.MaxFaultEnableCBClick(Sender: TObject);
begin
...
procedure TEngParamItemConfigForm2.MaxFaultSoundCBClick(Sender: TObject);
begin
  MaxFaultSoundEdit.Enabled := MaxFaultSoundCB.Checked;
end;

procedure TEngParamItemConfigForm2.MinAlarmSoundCBClick(Sender: TObject);
begin
  MinAlarmSoundEdit.Enabled := MinAlarmSoundCB.Checked;
end;

procedure TEngParamItemConfigForm2.MinFaultSoundCBClick(Sender: TObject);
begin
  MinFaultSoundEdit.Enabled := MinFaultSoundCB.Checked;
end;

procedure TEngParamItemConfigForm2.RecipientsEditButtonClick(Sender: TObject);
var
  LResult: string;
begin
...
procedure TEngParamItemConfigForm2.MaxAlarmEnableCBClick(Sender: TObject);
begin
...
procedure TEngParamItemConfigForm2.MaxAlarmSoundCBClick(Sender: TObject);
begin
