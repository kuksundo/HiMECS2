...
uses FrmSetMatrix2, FrmSetScalarValue2;
...
begin
  ...
  try
    ...
    FWG.NextGrid1.CellByName['SensorType','Last'].AsString :=
      g_SensorType.ToString(AParam.SensorType);
...
begin
  ...
  //begin
    ...
    try
      ...
      FWG.NextGrid1.CellByName['FUnit',Result].AsString := AParam.FFUnit;
      ...
      FWG.NextGrid1.CellByName['SensorType',Result].AsString :=
        g_SensorType.ToString(AParam.FSensorType);
...
begin
  ...
  try
    ...
    begin
      ...
      FWG.NextGrid1.CellByName['FUnit','Last'].AsString := AParam.EngineParameterCollect.Items[i].FUnit;
      FWG.NextGrid1.CellByName['Description','Last'].AsString := AParam.EngineParameterCollect.Items[i].Description;
      FWG.NextGrid1.CellByName['SensorType','Last'].AsString :=
        g_SensorType.ToString(AParam.EngineParameterCollect.Items[i].SensorType);
