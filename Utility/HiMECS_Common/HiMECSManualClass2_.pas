unit HiMECSManualClass2;

interface

uses System.SysUtils, Classes, Vcl.ComCtrls, Generics.Legacy,
  mormot.core.base, mormot.core.variants, mormot.rest.client, mormot.orm.core,
  JHP.BaseConfigCollect, HiMECSConst, UnitHiMECSManualRecord2, UnitEngineMasterData;
