...
type
  ...
  private
    ...
    FCreateDBInterval: integer;
    FIsRelativePath: Boolean;
    FAlarmFont: string;
    FAlarmCellColor,
    FAlarmTextColor,
    FShutdownCellColor,
    FShutdownTextColor: string;
  public
  ...
  published
    ...
    property CreateDBInterval: integer read FCreateDBInterval write FCreateDBInterval;
    property IsRelativePath: Boolean read FIsRelativePath write FIsRelativePath;
    property AlarmFont : string read FAlarmFont write FAlarmFont;
    property AlarmCellColor : string read FAlarmCellColor write FAlarmCellColor;
    property AlarmTextColor : string read FAlarmTextColor write FAlarmTextColor;
    property ShutdownCellColor : string read FShutdownCellColor write FShutdownCellColor;
    property ShutdownTextColor : string read FShutdownTextColor write FShutdownTextColor;
  end;
