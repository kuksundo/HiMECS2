...
function ShowEngParamItemConfigForm(AEPItem:TEngineParameterItem): integer;
var
  LForm: TEngParamItemConfigForm;
begin
  LForm := TEngParamItemConfigForm.Create(nil);
  try
...
procedure TEngParamItemConfigForm.InitCombo;
begin
...
procedure TEngParamItemConfigForm.LoadConfigForm2EngParamItem(AEPItem: TEngineParameterItem);
//var
