...
type
  TFrameElecPartEdit2 = class(TFrame)
...
constructor TFrameElecPartEdit2.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TFrameElecPartEdit2.Destroy;
begin
  DestroyVar;
...
procedure TFrameElecPartEdit2.DestroyVar;
begin
  FEngElecPartItem.Free;
end;

procedure TFrameElecPartEdit2.InitVar;
begin
...
procedure TFrameElecPartEdit2.Load2SensorRouteClass(AClass: TEngElecPartItem);
begin
  TINIConfigBase.LoadForm2Object(Self, AClass, False);
end;

procedure TFrameElecPartEdit2.LoadFromJsonString(AJson: string);
var
  LUtf8: RawUTF8;
  LValid: Boolean;
...
procedure TFrameElecPartEdit2.LoadFromSensorRouteClass(
