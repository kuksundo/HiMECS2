...
uses
  ...
  UnitDragDropRecord2,
  mormot.core.data, mormot.rest.sqlite3, mormot.rest.core, mormot.core.datetime,
  mormot.core.variants, mormot.orm.base, mormot.core.text, mormot.crypt.secure,
  mormot.core.os, mormot.core.unicode, mormot.orm.sql, mormot.orm.core, mormot.db.raw.sqlite3,
  mormot.core.base, mormot.core.json, mormot.soa.core, mormot.rest.memserver,
  Sx.DDD.Core,
...
type
  ...
  TFrameDecTreeView2 = class(TFrame)
  ...
  private
    ...
    function GetRestServerFromFileDBName(ADBName: string): TRest;
  public
...
//    FSensorRoute: TEngElecPartCollect;//TEngSensorCableRoute;
    ...
    procedure AddTVItem2DB(ARest: TRest);
    procedure AddItemFromAry2DB(ARest: TRest; ADynArr: TDynArray; ASensorRoute: TEngElecPartItemObjArray);
...
uses UnitTreeViewUtil, UnitRttiUtil2, UnitEncrypt2, UnitStringUtil, UnitProcessUtil,
  FrmEngParamConfig2, FrmElecPart2, FrmInputData1, FrmSimpleBrowser;
...
procedure TFrameDecTreeView2.AddItemFromAry2DB(ARest: TRest;
...
function TFrameDecTreeView2.AddNewTreeNode(ANode: TTreeNode; ASubNode,
...
procedure TFrameDecTreeView2.AddNodeBySubTagNameFromFileDB(ADBFileName: string);
var
...
procedure TFrameDecTreeView2.AddNodesFromSensorRouteClass(
...
procedure TFrameDecTreeView2.AddRootNodeFromSensorRouteClass(
...
function TFrameDecTreeView2.AddTreeNode4EngElecPart(AEngElecPartItem: TEngElecPartItem;
...
procedure TFrameDecTreeView2.AddTVItem2DB(ARest: TRest);
var
  i: integer;
  LEngElecPartItem: TEngElecPartItem;
  LCmd: IDomSensorCommand;
...
procedure TFrameDecTreeView2.ApplyTagName2Node(ANode: TTreeNode; AJson: string);
var
  LItem: TEngElecPartItem;
  LDoc: variant;
begin
...
procedure TFrameDecTreeView2.ClearTreeView;
begin
  decTreeView1.Items.Clear;
  FSensorRouteAry.Clear;
end;

procedure TFrameDecTreeView2.CopyTagInfo2EngElecPart(AClass: TEngSensorRouteTV);
begin

end;

constructor TFrameDecTreeView2.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameDecTreeView2.decTreeView1DblClick(Sender: TObject);
var
  LNode: TTreeNode;
...
procedure TFrameDecTreeView2.decTreeView1Deletion(Sender: TObject;
  Node: TTreeNode);
var
...
procedure TFrameDecTreeView2.decTreeView1DragDrop(Sender, Source: TObject; X, Y: Integer);
var
...
procedure TFrameDecTreeView2.decTreeView1DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
var
  Src, Dst: TTreeNode;
begin
...
procedure TFrameDecTreeView2.decTreeView1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrameDecTreeView2.decTreeView1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_CONTROL then
...
procedure TFrameDecTreeView2.decTreeView1MouseDown(Sender: TObject;
...
procedure TFrameDecTreeView2.decTreeView1MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  FMouseDown4InnerDragMode := False;
end;

procedure TFrameDecTreeView2.DeleteItem1Click(Sender: TObject);
var
//  HTreeNode: HTreeItem;
  LTreeNode: TTreeNode;
begin
...
procedure TFrameDecTreeView2.DeleteItemFromSensorRoute(ANode: TTreeNode; AJson: string);
var
  LItem: TEngElecPartItem;
  i: integer;
begin
...
destructor TFrameDecTreeView2.Destroy;
begin
  FTempParamItem.Free;
...
procedure TFrameDecTreeView2.DropTextTarget1Drop(Sender: TObject; ShiftState: TShiftState;
  APoint: TPoint; var Effect: Integer);
var
  LStr, LJson: string;
  LTreeNode: TTreeNode;
...
procedure TFrameDecTreeView2.est1Click(Sender: TObject);
var
  LJson: string;
begin
...
procedure TFrameDecTreeView2.GetEngElecPartItemAryFromSelectedNode(
  ADynArr: TDynArray);
var
  LNode: TTreeNode;
  LItem: TEngElecPartItem;
...
function TFrameDecTreeView2.GetEngParam2JSONFromDBByTagName(ATagName,
...
function TFrameDecTreeView2.GetJsonFromEngElecPartItemObjArray(
...
function TFrameDecTreeView2.GetJsonFromSelectedTV(ANode: TTreeNode; out AJson: string): integer;
var
...
procedure TFrameDecTreeView2.GetJsonFromTreeView(out AJson: string);
var
  LNode: TTreeNode;
...
function TFrameDecTreeView2.GetNodeFromDataItem(ATV: TTreeView; ALevel,
...
function TFrameDecTreeView2.GetPanelInfoRecFromTV(
...
function TFrameDecTreeView2.GetPLCInfoRecFromTV(ANode: TTreeNode): TPLCChannelInfoRec;
var
  LNode: TTreeNode;
  LItem: TEngElecPartItem;
begin
...
function TFrameDecTreeView2.GetPLCModuleNameFromTV: string;
var
  LNode: TTreeNode;
  LItem: TEngElecPartItem;
  LPanelName: string;
...
function TFrameDecTreeView2.GetRestServerFromFileDBName(
  ADBName: string): TRest;
var
...
//    LPath := ExeVersion.ProgramFilePath+'db\';
  ...
  Result := TRestExternalDBCreate( TOrmModel.Create([TSQLRecordEngElecPartItem]), LStore, false, []);
  Result.Model.Owner := Result;

  if Result is TRestServerDB then
    with TRestServerDB(Result) do begin // may be a client in settings :)
...
//    if Result is TRestServerDB then
//      TRestServerDB(Result).ServiceDefine(TInfraRepoSensor,[IDomSensorCommand,IDomSensorQuery],sicClientDriven);
end;

function TFrameDecTreeView2.GetSensorRouteItemByLevelNAbsIndex(
...
procedure TFrameDecTreeView2.InitDragDrop;
begin
...
function TFrameDecTreeView2.IsSamePanelName(ANode1, ANode2: TTreeNode): Boolean;
begin
...
function TFrameDecTreeView2.IsSubTagNameInCsv(ACsv,
...
procedure TFrameDecTreeView2.LoadBySubTagNameFromDBToSelectedSubNode1Click(
  Sender: TObject);
begin
  AddNodeBySubTagNameFromFileDB(DefaultSensorRouteDBFileName);
end;

procedure TFrameDecTreeView2.LoadBySubTagNameFromFileDB(ATargetNode: TTreeNode;
...
procedure TFrameDecTreeView2.LoadByTagnameFromDB1Click(Sender: TObject);
var
  LInputDataRec: TInputDataRec;
  LResult: integer;
begin
...
procedure TFrameDecTreeView2.LoadElecPartFromJson(AJson: string;
...
procedure TFrameDecTreeView2.LoadFromDB1Click(Sender: TObject);
begin
...
procedure TFrameDecTreeView2.LoadFromFile1Click(Sender: TObject);
begin
...
procedure TFrameDecTreeView2.LoadFromFileDB(ADBFileName: string; AProjectNo: TProjectNo;
...
//        Assert(LCmd.GetCount > 0);
    ...
    begin
//      RestClient := TRestClientURIDll.Create(TSQLModel.Create(RestServer.Model),@URIRequest);
//      try
...
procedure TFrameDecTreeView2.LoadFromJsonFile(AFileName: string; APassPhrase: string);
var
...
procedure TFrameDecTreeView2.LoadFromJsonString(ATargetNode: TTreeNode;
...
procedure TFrameDecTreeView2.LoadFromSensorRouteClass(ATargetNode: TTreeNode;
  AClass: TEngSensorRouteTV; ABySubTagName, AIsEdit: Boolean);
begin
...
procedure TFrameDecTreeView2.MoveNode(ATreeView: TTreeView; ATargetNode,
...
procedure TFrameDecTreeView2.Newitem1Click(Sender: TObject);
begin
  AddNewTreeNode(decTreeView1.Selected, False, False);
end;

procedure TFrameDecTreeView2.NewSubItem1Click(Sender: TObject);
begin
  AddNewTreeNode(decTreeView1.Selected, True, False);
end;

procedure TFrameDecTreeView2.NodeExpandWithSamePanelName;
var
  LNode: TTreeNode;
begin
...
procedure TFrameDecTreeView2.OnGetStream(
...
procedure TFrameDecTreeView2.ProcessCopyMode(AShiftState: TShiftState;
  APoint: TPoint);
begin
  ClearTreeView;
...
procedure TFrameDecTreeView2.ReArrangeDataItemIndexFromNode(ATV: TTreeView);
var
  LNode: TTreeNode;
  LItem: TEngElecPartItem;
begin
...
procedure TFrameDecTreeView2.SaveasSubTagFromSelectedToDB1Click(
  Sender: TObject);
begin
  SaveSelectedNode2FileDB(DefaultSensorRouteDBFileName);
end;

procedure TFrameDecTreeView2.SaveSelectedNode2FileDB(ADBFileName: string;
  AUseInternalClient: Boolean);
var
  RestServer: TRest;
  RestClient: TRestClientDB;
...
begin
  ...
  try
    ...
    begin
      RestClient := TRestClientDB.Create(TSQLModel.Create(RestServer.Model), nil, nil, TRestServerDB);
      try
        RestClient.Model.Owner := RestClient;
        RestClient.ServiceDefine([IDomSensorCommand],sicClientDriven);
//        USEFASTMM4ALLOC := true; // for slightly faster process
...
procedure TFrameDecTreeView2.SaveToDB(AUseMemDB: Boolean; ADBFileName: string);
var
  RestServer4MemDB: TRestServerFullMemory;
  RestServer: TRest;
  RestClient: TRestClientDB;
  LStore: TSynConnectionDefinition;
begin
...
procedure TFrameDecTreeView2.SaveToDB1Click(Sender: TObject);
begin
  SaveToDB(False, DefaultSensorRouteDBFileName);
end;

procedure TFrameDecTreeView2.SaveToFile1Click(Sender: TObject);
var
  LFileName: string;
begin
...
procedure TFrameDecTreeView2.SaveToFileDB(ADBFileName: string; AUseInternalClient: Boolean);
var
  RestServer: TRest;
  RestClient: TRestClientDB;
  LEngElecPartItem, LEngElecPartItem2: TEngElecPartItem;
...
procedure TFrameDecTreeView2.SaveToJsonFile(AFileName: string; APassPhrase: string);
var
  LJson: string;
  LStrList: TStringList;
  LMemStream: TMemoryStream;
...
procedure TFrameDecTreeView2.SaveToMemDB;
var
  RestServer4MemDB: TRestServerFullMemory;
  RestClient: TRestClientDB;
begin
  RestServer4MemDB := TRestServerFullMemory.CreateWithOwnModel([TSQLRecordEngElecPartItem]);
...
//    begin
      RestClient := TRestClientDB.Create(TSQLModel.Create(RestServer4MemDB.Model), nil, nil, TRestServerDB);
      try
        RestClient.Model.Owner := RestClient;
        RestClient.ServiceDefine([IDomSensorCommand],sicClientDriven);
//        USEFASTMM4ALLOC := true; // for slightly faster process
...
procedure TFrameDecTreeView2.SetAppPath(APath: string);
begin
  FAppPath := APath;
end;

procedure TFrameDecTreeView2.SetFileName(const AAppPath, ADrawingFN, AManualFN: string);
begin
  FAppPath := AAppPath;
...
procedure TFrameDecTreeView2.SetNodeInfo2SensorRoute(ANode: TTreeNode; AEngElecPartItem: TEngElecPartItem);
begin
...
procedure TFrameDecTreeView2.SetProjectInfo(AProjectNo, AEngineNo,
...
procedure TFrameDecTreeView2.ShowDiagram;
var
  LURL: string;
begin
...
procedure TFrameDecTreeView2.ShowDiagram1Click(Sender: TObject);
begin
  ShowDiagram;
end;

procedure TFrameDecTreeView2.UpdateEngElecPartItem2Node(ANode: TTreeNode;
  AEngElecPartItem: TEngElecPartItem);
begin
  ANode.Text := GetElecPartDisplayName(AEngElecPartItem);
end;

procedure TFrameDecTreeView2.UpdateEngParameterItem2Node(ANode: TTreeNode;
