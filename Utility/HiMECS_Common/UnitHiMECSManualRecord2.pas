...
function GetHiMECSManualFromDrawNo(const ADrawNo: string; AHiMECSManualDB: TSQLRestClientURI=nil): THiMECSManualRecord;
function GetHiMECSManualFromFileName(const AFileName: string; AHiMECSManualDB: TSQLRestClientURI=nil): THiMECSManualRecord;
