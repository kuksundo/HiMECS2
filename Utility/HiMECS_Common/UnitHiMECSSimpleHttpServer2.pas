unit UnitHiMECSSimpleHttpServer2;

interface

uses
  SysUtils,
  mormot.net.server, mormot.core.zip, mormot.db.proxy, mormot.net.http,
  mormot.core.text, mormot.core.base, mormot.core.unicode, mormot.core.buffers,
  mormot.core.os, mormot.rest.server;
...
function TSimpleHttpServer.DoOnRequest(Ctxt: THttpServerRequestAbstract): cardinal;
var W: TTextWriter;
    FileName: TFileName;
...
//      W.AddClassName(Ctxt.Server.ClassType);
    ...
    Ctxt.OutContentType := STATICFILE_CONTENT_TYPE;//HTTP_RESP_STATICFILE;
