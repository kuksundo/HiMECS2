unit UnitIPCClientAll_Generic2;
{
...
procedure TIPCClientAll<T>.AddIPCClientList(ASharedName: string;
...
constructor TIPCClientAll<T>.Create;
begin
  InitVar;
end;

procedure TIPCClientAll<T>.CreateIPCClient(APS: TParameterSource; ASharedName: string);
begin
...
procedure TIPCClientAll<T>.CreateIPCClientAll;
var
  i: integer;
...
destructor TIPCClientAll<T>.Destroy;
var
  i: integer;
begin
...
procedure TIPCClientAll<T>.DestroyIPCClient(AIPCClient: TParameterSource);
begin
...
function TIPCClientAll<T>.GetEngineName: string;
begin

end;

function TIPCClientAll<T>.GetEventName: string;
begin
  Result := FEventName;
end;

procedure TIPCClientAll<T>.InitVar;
begin
  FEngineParameter := TEngineParameter.Create(nil);
  FIPCClientList := TStringList.Create;
end;

//procedure TIPCClientAll<T>.PulseEventData(AData: TEventData_Modbus_Standard);
//var
//  i: integer;
...
procedure TIPCClientAll<T>.PulseEventData<T>(AData: T);
var
  i: integer;
  LParamSource:TParameterSource;
begin
...
//procedure TIPCClientAll<T>.PulseEventData_Dynamo(
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_ECS_AVAT(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_ECS_ComAP(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_ECS_ComAP2(
//  AData: TEventData_Modbus_Standard);
//var
//  LEventData: TEventData_Modbus_Standard;
//begin
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_ECS_kumo(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_ECS_Woodward(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_EngineParam(
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_FlowMeter(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_GasCalc(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_HIC(AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_KRAL(AData: TEventData_Modbus_Standard);
//var
//  LEventData: TEventData_Modbus_Standard;
//begin
//  System.Move(AData, LEventData, Sizeof(LEventData));
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_LBX(AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_MEXA7000(
//  AData: TEventData_MEXA7000_2);
//begin
//  FIPCClient_MEXA7000.PulseMonitor(AData);
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_MT210(AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_PLC_Modbus(
//  AData: TEventData_Modbus_Standard);
//var
//  LEventData: TEventData_Modbus_Standard;
//begin
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_PLC_S7(
//  AData: TEventData_Modbus_Standard);
//var
...
//end;
//
//procedure TIPCClientAll<T>.PulseEventData_PMSOPC(AData: TEventData_PMS);
//begin
//  FIPCClient_PMSOPC.PulseMonitor(AData);
//end;

procedure TIPCClientAll<T>.PulseEventData_Dynamo<T>(AData: T);
var
  LEventData: TEventData_DYNAMO;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_ECS_AVAT<T>(AData: T);
var
  LEventData: TEventData_ECS_AVAT;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_ECS_ComAP2<T>(AData: T);
var
  LEventData: TEventData_Modbus_Standard;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_ECS_ComAP<T>(AData: T);
var
  LEventData: TEventData_Modbus_Standard;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_ECS_kumo<T>(AData: T);
var
  LEventData: TEventData_ECS_kumo;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_ECS_Woodward<T>(AData: T);
var
  LEventData: TEventData_ECS_Woodward;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_EngineParam<T>(AData: T);
var
  LEventData: TEventData_EngineParam;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_FlowMeter<T>(AData: T);
var
  LEventData: TEventData_FlowMeter;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_GasCalc<T>(AData: T);
var
  LEventData: TEventData_GasCalc;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_HIC<T>(AData: T);
var
  LEventData: TEventData_HIC;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_KRAL<T>(AData: T);
var
  LEventData: TEventData_Modbus_Standard;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_LBX<T>(AData: T);
var
  LEventData: TEventData_LBX;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_MEXA7000<T>(AData: T);
var
...
procedure TIPCClientAll<T>.PulseEventData_MT210<T>(AData: T);
var
  LEventData: TEventData_MT210;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_PLC_Modbus<T>(AData: T);
var
  LEventData: TEventData_Modbus_Standard;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_PLC_S7<T>(AData: T);
var
  LEventData: TEventData_PLC_S7;
begin
  System.Move(AData, LEventData, Sizeof(LEventData));
...
procedure TIPCClientAll<T>.PulseEventData_PMSOPC<T>(AData: T);
var
...
procedure TIPCClientAll<T>.PulseEventData_WT1600(
  AData: TEventData_Modbus_Standard);
var
...
procedure TIPCClientAll<T>.ReadAddressFromParamFile(AFileName: string;
