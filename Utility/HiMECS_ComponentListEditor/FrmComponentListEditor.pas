...
uses
  ...
  JvCheckListBox, DragDropText, UnitHiMECSComponentCollect2, Dialogs, NxColumnClasses,
...
{$endif}
  SysUtils,
  CommCtrl, JvgXMLSerializer_Encrypt2;
...
begin
  ...
  begin
    ...
    begin
      ...
      case RGModeSelect.ItemIndex of
        //XML
        0: FHiMECSComponents.SaveToFile(SaveDialog1.FileName,LStr,True);
        //JSON
        1: FHiMECSComponents.SaveToJSONFile2(SaveDialog1.FileName,LStr,True);
        //Sqlite
//        2: FHiMECSComponents.SaveToSqliteFile(SaveDialog1.FileName,LStr,True);
      end;
...
begin
  ...
  begin
    ...
    begin
      ...
      case RGModeSelect.ItemIndex of
        //XML
        0: FHiMECSComponents.LoadFromFile(OpenDialog1.FileName,LStr,True);
        //JSON
        1: FHiMECSComponents.LoadFromJSONFile2(OpenDialog1.FileName,LStr,True);
        //Sqlite
//        2: FHiMECSComponents.LoadFromSqliteFile(OpenDialog1.FileName,LStr,True);
      end;
