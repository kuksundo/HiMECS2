unit FrmHiMECSConfig2;

interface

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, UnitConfig2, HiMECSConfigCollect2,
...
begin
  FHiMECSConfig := THiMECSConfig2.Create(Self);
  FFirst := True;
end;
...
//      LoadConfigCollect2Form(ConfigData);
      ConfigData.LoadConfigCollect2Form();

      if ShowModal = mrOK then
      begin
//        LoadConfigForm2Collect(ConfigData);
        ConfigData.LoadConfigForm2Collect();
        SaveAsConfigData(ConfigData);
      end;
    end;//with
  finally
