...
type
  TConfigF = class(TForm)
    ...
    Label23: TLabel;
    SensorRouteFilenameEdit: TJvFilenameEdit;
    Label24: TLabel;
    ModbusListFilenameEdit: TJvFilenameEdit;
  ...
  public
    ...
    procedure LoadConfigCollect2Form(AForm: TConfigF=nil);
    procedure LoadConfigForm2Collect(AForm: TConfigF=nil);
...
begin
  ...
  AForm.ModbusListFilenameEdit.Text := FHiMECSConfig.ModbusFileName;
  AForm.SensorRouteFilenameEdit.Text := FHiMECSConfig.SensorRouteFileName;
...
begin
  ...
  begin
    ...
    ParamFileName := IncludeTrailingBackslash(ExtractRelativePath(
                              ...
                              + ExtractFileName(ParamFilenameEdit.Text);
    ModbusFileName := IncludeTrailingBackslash(ExtractRelativePath(
                              LPath, ExtractFilePath(ModbusListFilenameEdit.Text)))
                              + ExtractFileName(ModbusListFilenameEdit.Text);
    SensorRouteFileName := IncludeTrailingBackslash(ExtractRelativePath(
                              LPath, ExtractFilePath(SensorRouteFilenameEdit.Text)))
                              + ExtractFileName(SensorRouteFilenameEdit.Text);
