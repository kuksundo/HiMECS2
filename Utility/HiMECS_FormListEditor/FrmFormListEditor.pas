...
uses
  ...
  JvCheckListBox, DragDropText, Dialogs, NxColumnClasses,
  NxColumns, NxScrollControl, NxCustomGridControl, NxCustomGrid, NxGrid,
  UnitHiMECSFormCollect2;
...
begin
  ...
  begin
    if not NextGrid1.CellByName['Select', i].AsBoolean then
    begin
      NextGrid1.DeleteRow(i);
    end;
  end;
