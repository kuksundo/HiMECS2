...
uses
  ...
  UnitProjectBaseClass2, NxColumns, NxColumnClasses, NxEdit,
  Vcl.Samples.Spin, UnitFrameProjInfo;
...
type
  TForm2 = class(TForm)
    ...
    ProjInfoFrame: THiMECSProjInfoFrame;
...
begin
  ...
  try
    ...
    ProjInfoFrame.LoadProjInfo2Form(FVesselInfo);
...
begin
  ProjInfoFrame.LoadProjInfo2Object(FVesselInfo);
  FVesselInfo.SaveToJSONFile(AFileName);
