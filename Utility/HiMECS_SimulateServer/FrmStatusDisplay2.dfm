object StatusDisplayF: TStatusDisplayF
  Left = 0
  Top = 0
  Caption = 'Status Display (F5: Stay On Top)'
  ClientHeight = 142
  ClientWidth = 1113
  Color = clBtnFace
  ...
  object StatusStepControl: TAdvSmoothStepControl
    Left = 0
    Top = 33
    Width = 1113
    Height = 109
    ...
    Appearance.InActiveCaptionFont.Height = -24
    Appearance.InActiveCaptionFont.Name = 'Tahoma'
    Appearance.InActiveCaptionFont.Style = [fsItalic]
    ...
    Appearance.ActiveCaptionFont.Height = -27
    Appearance.ActiveCaptionFont.Name = 'Tahoma'
    Appearance.ActiveCaptionFont.Style = [fsBold]
    ...
    Appearance.InActiveDescriptionFont.Height = -27
    Appearance.InActiveDescriptionFont.Name = 'Tahoma'
    Appearance.InActiveDescriptionFont.Style = [fsBold, fsItalic]
    ...
    Appearance.ActiveDescriptionFont.Color = clBlue
    Appearance.ActiveDescriptionFont.Height = -27
    Appearance.ActiveDescriptionFont.Name = 'Tahoma'
    Appearance.ActiveDescriptionFont.Style = [fsBold]
    ...
    TabOrder = 1
    OnKeyDown = StatusStepControlKeyDown
  end
  ...
  object PopupMenu1: TPopupMenu
    Left = 544
    object AdjustDescriptHeight1: TMenuItem
      Caption = 'Adjust Descript Height'
      OnClick = AdjustDescriptHeight1Click
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object ShowShortCut1: TMenuItem
      Caption = 'Show Short-Cut'
      OnClick = ShowShortCut1Click
    end
  end
end
